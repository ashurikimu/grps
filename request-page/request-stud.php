...
<html>
    <head>
        <title></title>
        <link rel="stylesheet" href="styles3-stud.css">
    ...
    <body>
        ...
        <div class="Container">
            ...
            <br>
            <p>Enter your name:</p>
            <input type="text" class="centeritem" placeholder="Enter your name" name="name">
            <br>
            <p>Enter your i.d. number</p>
            <input type="text" class="centeritem" placeholder="Enter your I.D. number" name="idnum">
            <br>
            <p>Enter your birthday</p>
            <input type="text" class="centeritem" name="bday" placeholder="This will serve as your password" onfocus="(this.type='date')">
            <br>
            <p>Enter your email</p>
            <input type="email" class="centeritem" placeholder="Enter your email" name="email">
            <br>
            <p>Enter your course (bsit or bscs)</p>
            <input type="email" class="centeritem" placeholder="Enter your course" name="course">
            <br>
