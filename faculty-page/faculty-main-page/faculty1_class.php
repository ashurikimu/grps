...
session_start();
    ...
    //fetching data
    $query = "select * from faculty1db WHERE block = 'A' ";
        ...
        <div class="academic-evaluation">
            <h1 class="ae">Academic Evaluation</h1>
                ...
                <div id="id02" class="modal1">
                    ...
                    <form class="modal1-content" action="insert_data.php" method="post">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            ?>
                                ...
                                <th><a href="delete_page.php?idnum=<?php echo htmlspecialchars($row['idnum']); ?>"><i class="fa fa-trash-o" style="color:red;"></i></a></th>
