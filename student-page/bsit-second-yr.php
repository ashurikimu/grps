...
session_start();
    ...
    $query_faculty = "SELECT * FROM faculty1db WHERE yr_level = '2' AND idnum = '$username' AND semester = '1st'
                        UNION 
                        SELECT * FROM faculty2db WHERE yr_level = '2' AND idnum = '$username' AND semester = '1st'";
