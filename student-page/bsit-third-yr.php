...
session_start();
    ...
    $query_faculty = "SELECT * FROM faculty1db WHERE yr_level = '3' AND idnum = '$username' AND semester = '1st'
                        UNION 
                        SELECT * FROM faculty2db WHERE yr_level = '3' AND idnum = '$username' AND semester = '1st'";
...
<!-- logout confirmation -->
    ...
    <div class="container">
        <div class="academic-evaluation">
            ...
            <div class="final">
                <h2>THIRD YEAR - SECOND SEMESTER</h2>
                <table class="tbl">
                    <thead>
                        <tr>
                            <th>Name</th>
